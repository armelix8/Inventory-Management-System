    ...
    <div className="flex min-h-screen bg-slate-100">
      ...
      <aside className="w-64 bg-slate-800 text-white flex flex-col shrink-0">
        ...
        <nav className="flex-1 p-3 space-y-1 overflow-y-auto">
          <SidebarLink to="/dashboard" icon={icons.dashboard} active={pathname === '/dashboard'}>
            Dashboard
          </SidebarLink>
          <SidebarLink to="/items" icon={icons.product} active={pathname === '/items'}>
            Items
          </SidebarLink>
          <SidebarLink to="/stock-out" icon={icons.sales} active={pathname === '/stock-out'}>
            Stock Out
          </SidebarLink>
          {user?.role && user.role !== 'USER' && (
            <SidebarLink to="/stock-in" icon={icons.purchase} active={pathname === '/stock-in'}>
              Stock In
            </SidebarLink>
          )}
          <SidebarLink to="/suppliers" icon={icons.suppliers} active={pathname === '/suppliers'}>
            Suppliers
          </SidebarLink>
          {(user?.role === 'ADMIN' || user?.role === 'MANAGER') && (
            <SidebarLink to="/users" icon={icons.people} active={pathname === '/users'}>
              Users
            </SidebarLink>
          )}
        </nav>
