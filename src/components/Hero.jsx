      ...
      <div className="hero-container">
        <div className="hero-content">
          <div className="hero-text">
            ...
            <h2 className="hero-title">Software Developer & Engineer</h2>
            <p className="hero-description">
              I build exceptional digital experiences through clean code, 
              innovative solutions, and a passion for technology. 
            ...
            <div className="hero-avatar">
              <div className="avatar-placeholder">
                <svg width="200" height="200" viewBox="0 0 200 200" fill="none">
                  ...
                  <path d="M100 120c-25 0-45 15-45 35v15h90v-15c0-20-20-35-45-35z" fill="#9ca3af"/>
                </svg>
              </div>
            </div>
          </div>
